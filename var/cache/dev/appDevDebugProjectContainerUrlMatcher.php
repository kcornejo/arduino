...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'SoporteBundle\\Controller\\BitacoraController::indexAction',  '_route' => 'soporte_homepage',);
        }

        // soporte_borrar
        if ($pathinfo === '/borrar') {
            return array (  '_controller' => 'SoporteBundle\\Controller\\BitacoraController::borrarAction',  '_route' => 'soporte_borrar',);
        }

        // soporte_guardar
        if ($pathinfo === '/guardar') {
            return array (  '_controller' => 'SoporteBundle\\Controller\\BitacoraController::guardarAction',  '_route' => 'soporte_guardar',);
        }

        // soporte_ajax
        if ($pathinfo === '/ajax') {
            return array (  '_controller' => 'SoporteBundle\\Controller\\BitacoraController::ajaxAction',  '_route' => 'soporte_ajax',);
        }
