...
class __TwigTemplate_87dc8b2571206ff981e52b8f85f74ec01ee709d22665503bd53b690bf016f793 extends \Twig\Template
{
    private $source;
    ...
    ";
        ...
        if (((isset($context["count"]) || array_key_exists("count", $context) ? $context["count"] : (function () { throw new RuntimeError('Variable "count" does not exist.', 2, $this->source); })()) > 0)) {
            ...
            ";
            // line 5
            echo $this->extensions['Symfony\Bridge\Twig\Extension\CodeExtension']->abbrClass(twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new RuntimeError('Variable "exception" does not exist.', 5, $this->source); })()), "class", []));
            echo ": ";
            echo $this->extensions['Symfony\Bridge\Twig\Extension\CodeExtension']->formatFileFromText(nl2br(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new RuntimeError('Variable "exception" does not exist.', 5, $this->source); })()), "message", []), "html", null, true)));
            echo "&nbsp;
            ";
            // line 6
            ob_start();
    ...
    <ol class=\"traces list-exception\" id=\"traces-";
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new RuntimeError('Variable "exception" does not exist.', 19, $this->source); })()), "trace", []));
        foreach ($context['_seq'] as $context["i"] => $context["trace"]) {
            // line 20
            echo "            <li>
                ";
            // line 21
            $this->loadTemplate("@Twig/Exception/trace.html.twig", "@Twig/Exception/traces.html.twig", 21)->display(["prefix" => (isset($context["position"]) || array_key_exists("position", $context) ? $context["position"] : (function () { throw new RuntimeError('Variable "position" does not exist.', 21, $this->source); })()), "i" => $context["i"], "trace" => $context["trace"]]);
            // line 22
            echo "            </li>
        ";
        }
...
";
    ...
    {
        return array (  123 => 24,  116 => 22,  114 => 21,  111 => 20,  107 => 19,  101 => 18,  97 => 17,  94 => 16,  90 => 14,  86 => 12,  78 => 9,  72 => 8,  63 => 7,  61 => 6,  55 => 5,  49 => 4,  46 => 3,  44 => 2,  41 => 1,);
    }
...
", "@Twig/Exception/traces.html.twig", "/media/kcornejo/2b71ea5e-3775-4eb8-8305-755f05f052fa/workspace/symfony/arduino/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views/Exception/traces.html.twig");
    }
}
